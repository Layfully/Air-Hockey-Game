...
namespace UnityStandardAssets.ImageEffects
{
    ...
    class ColorCorrectionCurvesEditor : Editor {
        ...
        void CurveGui ( string myName, SerializedProperty animationCurve, Color color) {
        ...
        void ApplyCurves () {
            ...
            {
                serObj.ApplyModifiedProperties ();
                var colorCorrectionCurves = serObj.targetObject as ColorCorrectionCurves;
                if (colorCorrectionCurves != null)
                    colorCorrectionCurves.gameObject.SendMessage ("UpdateTextures");
            }
        }
